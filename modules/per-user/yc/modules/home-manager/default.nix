    ...
    home-manager.users.yc = {
      ...
      programs.zathura = {
        ...
        mappings = {
          ...
          "map [fullscreen]" = "<A-Space>   navigate next";
          "map [fullscreen]" = "<A-s>   toggle_statusbar";
          "map [fullscreen]" = "<BackSpace>   scroll full-up";
          "map [fullscreen]" = "<A-BackSpace>   navigate previous";
          "map [fullscreen]" = "a   scroll full-left";
          "map [fullscreen]" = "b   scroll left";
          "map [fullscreen]" = "e   scroll full-right";
          ...
          "map [normal]" = "+   zoom in";
          "map [normal]" = "-   zoom out";
          "map [normal]" = "<A-Space>   navigate next";
          "map [normal]" = "<A-s>   toggle_statusbar";
          "map [normal]" = "<BackSpace>   scroll full-up";
          "map [normal]" = "<A-BackSpace>   navigate previous";
          "map [normal]" = "a   scroll full-left";
          "map [normal]" = "b   scroll left";
          "map [normal]" = "e   scroll full-right";
